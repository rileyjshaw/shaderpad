...
out vec4 outColor;
void main() { outColor = texture(u_texture, v_uv); }`,`face-mask-blit`),s;try{let e=i.createBuffer(),n=i.getAttribLocation(a,`a_pos`),c=i.createBuffer();i.bindBuffer(i.ARRAY_BUFFER,c),i.bufferData(i.ARRAY_BUFFER,r,i.STATIC_DRAW);let l=i.getAttribLocation(o,`a_pos`),u=i.getUniformLocation(a,`u_color`),d=i.getUniformLocation(o,`u_texture`),f=i.createTexture();i.bindTexture(i.TEXTURE_2D,f),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MAG_FILTER,i.NEAREST),i.texImage2D(i.TEXTURE_2D,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,null);let p=i.createFramebuffer();if(i.bindFramebuffer(i.FRAMEBUFFER,p),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,f,0),s=i.checkFramebufferStatus(i.FRAMEBUFFER),i.bindFramebuffer(i.FRAMEBUFFER,null),!e||n<0||!c||l<0||!u||!d||!f||!p||s!==i.FRAMEBUFFER_COMPLETE)throw Error();return i.useProgram(o),i.uniform1i(d,0),i.colorMask(!0,!0,!0,!1),{canvas:t,gl:i,regionProgram:a,blitProgram:o,regionPositionBuffer:e,quadBuffer:c,regionPositionLocation:n,blitPositionLocation:l,colorLocation:u,textureLocation:d,scratchTexture:f,scratchFramebuffer:p}}catch{throw e.r(62,!1)}}function O(e,t,n){let{gl:r,canvas:i,scratchTexture:a}=e;(i.width!==t||i.height!==n)&&(i.width=t,i.height=n,r.bindTexture(r.TEXTURE_2D,a),r.texImage2D(r.TEXTURE_2D,0,r.RGBA,t,n,0,r.RGBA,r.UNSIGNED_BYTE,null))}function k(e,t,n,r,i,a,o){let{gl:s,regionProgram:c,regionPositionBuffer:l,regionPositionLocation:u,colorLocation:d,scratchFramebuffer:f}=e,p=1+r*480,{indices:m,vertices:h}=n;s.bindFramebuffer(s.FRAMEBUFFER,f),s.viewport(0,0,e.canvas.width,e.canvas.height),s.clearColor(0,0,0,0),s.clear(s.COLOR_BUFFER_BIT),s.useProgram(c),s.bindBuffer(s.ARRAY_BUFFER,l),s.enableVertexAttribArray(u),s.vertexAttribPointer(u,2,s.FLOAT,!1,0,0),s.enable(s.BLEND),s.blendEquation(s.MAX),s.blendFunc(s.ONE,s.ONE);for(let e=0;e<m.length;++e){let n=(p+m[e])*4;h[e*2]=t[n],h[e*2+1]=t[n+1]}s.bufferData(s.ARRAY_BUFFER,h,s.DYNAMIC_DRAW),s.uniform4f(d,i,a,o,1),s.drawArrays(s.TRIANGLES,0,m.length)}function A(e){let{gl:t,blitProgram:n,quadBuffer:r,blitPositionLocation:i,scratchTexture:a}=e;t.bindFramebuffer(t.FRAMEBUFFER,null),t.viewport(0,0,e.canvas.width,e.canvas.height),t.useProgram(n),t.bindBuffer(t.ARRAY_BUFFER,r),t.enableVertexAttribArray(i),t.vertexAttribPointer(i,2,t.FLOAT,!1,0,0),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,a),t.enable(t.BLEND),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ONE),t.drawArrays(t.TRIANGLES,0,6)}function j(e,n){let r=e.landmarks,o=n.length;r[0]=o;for(let e=0;e<o;++e){let o=n[e];for(let t=0;t<478;++t){let n=o[t],i=(1+e*480+t)*4;r[i]=n.x,r[i+1]=1-n.y,r[i+2]=n.z??0,r[i+3]=n.visibility??1}let s=t.calculateBoundingBoxCenter(r,e,i,480,1);r.set(s,(1+e*480+478)*4);let c=t.calculateBoundingBoxCenter(r,e,a,480,1);r.set(c,(1+e*480+479)*4)}e.state.nFaces=o}function M(e,t,n){let{mask:r,maxFaces:i,landmarks:a,state:{nFaces:o}}=e,{gl:u,canvas:d}=r,f=a;if(O(r,t,n),u.bindFramebuffer(u.FRAMEBUFFER,null),u.viewport(0,0,d.width,d.height),u.clearColor(0,0,0,0),u.clear(u.COLOR_BUFFER_BIT),!S)return;let p=i<=l;for(let e=0;e<o;++e){let t=p&&e<s.length?g[s[e]]:0,n=p?e<s.length?0:_[c[e-s.length]]:(e+1)/255;k(r,f,S.TESSELATION,e,0,t,n),A(r),k(r,f,S.OVAL,e,h.OVAL,0,0),A(r),k(r,f,S.LEFT_EYEBROW,e,h.LEFT_EYEBROW,0,0),A(r),k(r,f,S.RIGHT_EYEBROW,e,h.RIGHT_EYEBROW,0,0),A(r),k(r,f,S.LEFT_EYE,e,h.LEFT_EYE,0,0),A(r),k(r,f,S.RIGHT_EYE,e,h.RIGHT_EYE,0,0),A(r),k(r,f,S.MOUTH,e,h.MOUTH,0,0),A(r),k(r,f,S.INNER_MOUTH,e,h.INNER_MOUTH,0,0),A(r)}}function N(e){let{textureName:n,wasmBaseUrl:r=t.DEFAULT_WASM_BASE_URL,options:{history:i,...a}={}}=e,o={...v,...a},s=t.hashOptions({...o,textureName:n,wasmBaseUrl:r}),c=o.maxFaces*480+1,u=Math.ceil(c/512);return function(e,a){let{injectGLSL:c,emit:d,updateTexture:p}=a,m=w.get(s),h=m?.landmarks??new Float32Array(512*u*4),g=m?.mask.canvas??new OffscreenCanvas(1,1),_,v=!1,y=-1,b=[];function x(t){if(v||!_)return;let n=_.state.nFaces,r=n*480+1,a=Math.ceil(r/512),o=i?t:void 0;p(`u_faceLandmarksTex`,{data:_.landmarks,width:512,height:a,isPartial:!0},o),p(`u_faceMask`,_.mask.canvas,o),e.updateUniforms({u_nFaces:n},{allowMissing:!0})}function S(){v||!_||(i?(x(b.length>0?b:y),b=[]):x(y),d(`face:result`,_.state.result))}function E(){if(v||!_)return;let e=_.subscribers;for(let[t,n]of e)if(n){if(t(),v)return;e.has(t)&&e.set(t,!1)}}async function O(){_=await t.getOrCreateSharedResource(s,w,T,async()=>{let[e,{FaceLandmarker:n}]=await Promise.all([t.getSharedFileset(r),import(`@mediapipe/tasks-vision`)]);if(v)return;let i=await n.createFromOptions(e,{baseOptions:{modelAssetPath:o.modelPath,delegate:o.delegate},canvas:new OffscreenCanvas(1,1),runningMode:`VIDEO`,numFaces:o.maxFaces,minFaceDetectionConfidence:o.minFaceDetectionConfidence,minFacePresenceConfidence:o.minFacePresenceConfidence,minTrackingConfidence:o.minTrackingConfidence,outputFaceBlendshapes:o.outputFaceBlendshapes,outputFacialTransformationMatrixes:o.outputFacialTransformationMatrixes});if(v){i.close();return}let a={landmarker:i,mask:D(g),subscribers:new Map,maxFaces:o.maxFaces,state:{nCalls:0,runningMode:`VIDEO`,source:null,videoTime:-1,resultTimestamp:0,result:null,pending:Promise.resolve(),nFaces:0},landmarks:h};return C(n),a}),!(!_||v)&&_.subscribers.set(S,!1)}let k=O().catch(e=>{v||t.reportMediaPipeError(e,`face`)});async function A(e){let t=performance.now();if(await k,v||!_)return;let n=++_.state.nCalls;_.state.pending=_.state.pending.then(async()=>{if(v||!_||n!==_.state.nCalls)return;let r=e instanceof HTMLVideoElement?`VIDEO`:`IMAGE`;if(_.state.runningMode!==r&&(_.state.runningMode=r,await _.landmarker.setOptions({runningMode:r}),v||!_||n!==_.state.nCalls))return;let i=!1;if(e===_.state.source?e instanceof HTMLVideoElement?e.currentTime!==_.state.videoTime&&(_.state.videoTime=e.currentTime,i=!0):e instanceof HTMLImageElement||t-_.state.resultTimestamp>2&&(i=!0):(_.state.source=e,_.state.videoTime=e instanceof HTMLVideoElement?e.currentTime:-1,i=!0),i){let n,r,i;if(e instanceof HTMLVideoElement){if(e.videoWidth===0||e.videoHeight===0||e.readyState<2)return;r=e.videoWidth,i=e.videoHeight,n=_.landmarker.detectForVideo(e,t)}else{if(e.width===0||e.height===0)return;r=e.width,i=e.height,n=_.landmarker.detect(e)}n&&(_.state.resultTimestamp=t,_.state.result=n,j(_,n.faceLandmarks),M(_,r,i),E())}else _.state.result&&E()}),await _.state.pending}e.on(`_init`,()=>{e.initializeUniform(`u_maxFaces`,`int`,o.maxFaces,{allowMissing:!0}),e.initializeUniform(`u_nFaces`,`int`,0,{allowMissing:!0}),e.initializeTexture(`u_faceLandmarksTex`,{data:h,width:512,height:u},{format:`RGBA32F`,minFilter:`NEAREST`,magFilter:`NEAREST`,history:i}),e.initializeTexture(`u_faceMask`,g,{minFilter:`NEAREST`,magFilter:`NEAREST`,history:i}),k.then(()=>{v||!_||d(`face:ready`)})});function N(e){v||!_||(i&&(y=(y+1)%(i+1),x(y),b.push(y)),_.subscribers.set(S,!0),A(e))}e.on(`initializeTexture`,(e,r)=>{e===n&&t.isMediaPipeSource(r)&&N(r)}),e.on(`updateTextures`,e=>{let r=e[n];t.isMediaPipeSource(r)&&N(r)}),e.on(`destroy`,()=>{v=!0,_&&(_.subscribers.delete(S),_.subscribers.size===0&&(_.landmarker.close(),_.mask.gl.deleteProgram(_.mask.regionProgram),_.mask.gl.deleteProgram(_.mask.blitProgram),_.mask.gl.deleteBuffer(_.mask.regionPositionBuffer),_.mask.gl.deleteBuffer(_.mask.quadBuffer),_.mask.gl.deleteTexture(_.mask.scratchTexture),_.mask.gl.deleteFramebuffer(_.mask.scratchFramebuffer),w.delete(s))),_=void 0});let{fn:P,historyParams:F}=t.generateGLSLFn(i),I=i?`_sampleFaceMask(pos, framesAgo)`:`texture(u_faceMask, pos)`,L=Array.from({length:l-1},(e,t)=>`step(${2**(t+1)}.0, faceBitF)`).join(` + `),R=o.maxFaces<=l?`uint faceBits = (uint(mask.b * 255.0 + 0.5) << 8) | uint(mask.g * 255.0 + 0.5);
	uint faceBit = faceBits & (~faceBits + 1u);
	float faceBitF = float(faceBit);
	float hasFace = sign(faceBitF);
	float faceIndex = ${L} - (1.0 - hasFace);`:`float faceIndex = float(int(uint(mask.b * 255.0 + 0.5)) - 1);`,z=(e,...t)=>P(`vec2`,`${e}At`,`vec2 pos`,`vec4 mask = ${I};
	${R}
	uint bits = uint(mask.r * 255.0 + 0.5);
	float hit = sign(float(bits & ${t.reduce((e,t)=>e|f[t],0)}u));
	return vec2(hit, mix(-1.0, faceIndex, hit));`),B=(e,t,n)=>P(`vec2`,`${e}At`,`vec2 pos`,`vec2 left = ${t}(pos${F});
	vec2 right = ${n}(pos${F});
...
${P(`vec4`,`faceLandmark`,`int faceIndex, int landmarkIndex`,`int i = 1 + faceIndex * 480 + landmarkIndex;
	int x = i % 512;
	int y = i / 512;${i?`
	int layer = (u_faceLandmarksTexFrameOffset - framesAgo + ${i+1}) % ${i+1};
...
`:``}
${z(`leftEyebrow`,`LEFT_EYEBROW`)}
${z(`rightEyebrow`,`RIGHT_EYEBROW`)}
${z(`leftEye`,`LEFT_EYE`)}
${z(`rightEye`,`RIGHT_EYE`)}
${z(`lips`,`MOUTH`)}
${z(`mouth`,`MOUTH`,`INNER_MOUTH`)}
${z(`innerMouth`,`INNER_MOUTH`)}
${z(`faceOval`,`OVAL`)}
${P(`vec2`,`faceAt`,`vec2 pos`,`vec4 mask = ${I};
	${R}
	return vec2(step(0.0, faceIndex), faceIndex);`)}
${B(`eye`,`leftEyeAt`,`rightEyeAt`)}
${B(`eyebrow`,`leftEyebrowAt`,`rightEyebrowAt`)}
${(e=>e.map(e=>P(`float`,`in${e[0].toUpperCase()+e.slice(1)}`,`vec2 pos`,`vec2 a = ${e}At(pos${F}); return step(0.0, a.y) * a.x;`)).join(`
