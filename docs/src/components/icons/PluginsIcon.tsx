	...
	return (
		<>
			...
			<LightMode>
				...
				<path d="M11 4h8v2l6 3-10 6L5 9l6-3V4Z" fillOpacity={0.5} className="fill-(--icon-background)" />
				<g className="stroke-(--icon-foreground)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
