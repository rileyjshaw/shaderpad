...
export function TableOfContents({ tableOfContents }: { tableOfContents: Array<Section> }) {
	...
	return (
		<div className="hidden xl:absolute xl:top-0 xl:right-0 xl:block xl:w-56">
			<div className="xl:sticky xl:top-19 xl:h-[calc(100vh-4.75rem)] xl:overflow-y-auto xl:py-16 xl:pr-6">
