...
export function Layout({ children }: { children: React.ReactNode }) {
	...
	let isAiGuidePage = pathname === AI_GUIDE_PATH || pathname === `${AI_GUIDE_PATH}/`;
			...
			{!isAiGuidePage && (
				<footer className="relative z-10 border-t border-slate-200 bg-white px-4 py-4 sm:px-6 lg:px-8 dark:border-slate-800 dark:bg-slate-900">
					<div className="mx-auto flex w-full max-w-8xl justify-center">
						<p className="max-w-2xl text-center text-sm text-balance text-slate-600 dark:text-slate-400">
							Written by{' '}
							<a className="underline" href="https://rileyjshaw.com">
								Riley
							</a>{' '}
							at{' '}
							<a className="underline" href="https://misery.co">
								Misery &amp; Company
							</a>
