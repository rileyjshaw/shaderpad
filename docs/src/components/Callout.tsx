...
const styles = {
  note: {
    ...
    body: 'text-sky-800 [--tw-prose-background:var(--color-sky-50)] prose-a:text-sky-900 prose-code:text-sky-900 dark:prose-code:text-slate-300 dark:text-slate-300',
  },
  warning: {
    container:
