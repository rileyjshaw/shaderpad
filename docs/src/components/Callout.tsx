...
const styles = {
	note: {
		...
		body: 'text-sky-800 [--tw-prose-background:var(--color-sky-50)] prose-a:text-sky-900 prose-code:text-slate-300 dark:prose-code:text-slate-300 dark:text-slate-300',
	},
	warning: {
	...
	return (
		<div className={clsx('my-8 flex rounded-3xl p-6', styles[type].container)}>
			...
			<div className="ml-4 min-w-0 flex-auto">
				...
				<div className={clsx('prose mt-2.5 [&_pre]:max-w-full [&_pre]:overflow-x-auto', styles[type].body)}>
					{children}
				</div>
			</div>
		</div>
