...
import { ShaderPadSizeBadge } from '@/components/ShaderPadSize';
import blurCyanImage from '@/images/blur-cyan.png';
import blurIndigoImage from '@/images/blur-indigo.png';

const codeLanguage = 'typescript';
const code = `// Fragmentum shader by Jaenam: shadertoy.com/view/t3SyzV
					...
					<div className="relative z-10 md:text-center lg:text-left">
						...
						<div className="relative">
							...
							<p className="mt-3 text-2xl tracking-tight text-slate-400">
								ShaderPad is a lightweight, embeddable fragment shader player. It lets you add stunning
								creative effects to your website with minimal setup.
							</p>
