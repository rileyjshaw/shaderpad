...
export type ExampleModule = {
	init: (context: ExampleContext) => Promise<void | ExampleCleanup> | void | ExampleCleanup;
	destroy?: () => void;
};

export function createExampleContext(mount: HTMLElement, overlay: HTMLElement): ExampleContext {
	return {
		mount,
		overlay,
