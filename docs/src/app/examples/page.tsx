          ...
          <section className="mt-10 overflow-hidden rounded-[2rem] border border-sky-200 bg-linear-to-br from-sky-50 via-white to-cyan-50 p-7 shadow-lg shadow-sky-100/60 dark:border-sky-900/60 dark:from-sky-950/40 dark:via-slate-950 dark:to-cyan-950/40 dark:shadow-none">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="max-w-2xl space-y-3">
                <span className="inline-flex rounded-full border border-sky-300 bg-white/80 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-sky-700 dark:border-sky-700 dark:bg-sky-950/40 dark:text-sky-300">
                  Featured
                </span>
                <div className="space-y-2">
                  ...
                  <p className="text-base leading-7 text-slate-700 dark:text-slate-300">
                    A camera app built specifically to demo and test ShaderPad. Start here if you want to see ShaderPad in a real-world application
                    instead of isolated feature demos.
                  </p>
                </div>
              </div>
