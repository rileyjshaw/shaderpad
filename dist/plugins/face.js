...
${b("vec4","faceLandmark","int faceIndex, int landmarkIndex",`int i = ${L} + faceIndex * ${g} + landmarkIndex;
	int x = i % ${k};
	int y = i / ${k};${t?`
	int layer = (u_faceLandmarksTexFrameOffset - framesAgo + ${t+1}) % ${t+1};
...
${M("lips","OUTER_MOUTH")}
${M("mouth","OUTER_MOUTH","INNER_MOUTH")}
